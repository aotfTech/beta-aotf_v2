...
const permissionsSchema = new Schema(
  {
    ...
    canManageWhatsAppGroups: { type: Boolean, default: false },
    ...
    canRecoverPayments: { type: Boolean, default: false },
...
// (Admin syncing to Google Sheets has been removed by request)
