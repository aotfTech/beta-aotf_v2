...
|---|---|
| Catch unexpected 500s | API routes, webhooks, and the admin UI report unhandled errors |
...
- Direct `reportError()` in routes that need custom context (webhooks, proxy)
